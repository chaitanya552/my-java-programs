...
class AddElements2ConditionsOption1_Ap implements RecentItems
{
    ...
    public void add(final String d)
    {
    ...
    {
        final List orderedList = new LinkedList(set);
...
public class AddElementsRetrieveLast4_Ap
{
    public static void main(final String[] args)
    {
        ...
        final AddElements2ConditionsOption1_Ap r = new AddElements2ConditionsOption1_Ap();
        r.add("a");
        r.add("b");
        r.add("c");
        r.add("b");
        ...
        final AddElements2ConditionsOption2_Ap s = new AddElements2ConditionsOption2_Ap();
        s.add("a");
        s.add("b");
        s.add("c");
        s.add("b");
