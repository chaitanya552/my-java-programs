...
class NodeT
{
    ...
    NodeT(final int key, final String name)
    {
        this.key = key;
        this.name = name;
    }
...
public class BinarySearchTreeWithEmployee
{
    ...
    {
        final NodeT newNode = new NodeT(key, name);
        if (root == null) {
    ...
    public void inOrderTraversal(final NodeT focusNode)
    {
        if (focusNode != null) {
    ...
    public String findNode(final int key)
    {
    ...
    public int getHeight(final NodeT focusNode)
    {
        ...
        if (focusNode == null) {
            ...
            final int ldepth = getHeight(focusNode.LeftChild);
            final int rdepth = getHeight(focusNode.RightChild);
            if (ldepth > rdepth) {
                return (ldepth + 1);
    ...
    public static void main(final String[] args)
    {
        ...
        final BinarySearchTreeWithEmployee a1 = new BinarySearchTreeWithEmployee();
