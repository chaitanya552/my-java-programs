...
public class ImplementQueueInterfaceUsingLinkedList<Object> implements Queue<Object> {
	...
	public static void main(String[] args)
	{
		...
		ImplementQueueInterfaceUsingLinkedList<Integer> q1  = new ImplementQueueInterfaceUsingLinkedList<Integer>();
		q1.add(1);
		q1.add(2);
		q1.add(3);
		q1.add(4);
		...
		ImplementQueueInterfaceUsingLinkedList<String> q2  = new ImplementQueueInterfaceUsingLinkedList<String>();
		q2.add("no1");
		q2.add("no2");
		q2.add("no3");
		q2.add("no4");
